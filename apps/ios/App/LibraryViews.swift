        ...
        NavigationStack {
            Form {
                ...
                Section {
                    ...
                    LabeledContent("Voice estimate", value: String(format: "$%.2f USD", totalVoiceCost))
