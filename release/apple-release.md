...
- [x] Prepare four **1320 × 2868** PNGs without transparency in [screenshots/en-US](screenshots/en-US/README.md). They show the current core interface and still contain Spanish sample content from an earlier build; recapture them with Korean sample content before upload. Apple accepts one to ten screenshots per set; the current target is iPhone-only. [Screenshot specifications](https://developer.apple.com/help/app-store-connect/reference/app-information/screenshot-specifications/)
